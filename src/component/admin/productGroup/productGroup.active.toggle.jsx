...
import { updateProductGroupAPI } from "../../../services/api.services.js";
import { useContext, useState } from "react";
import { NotifyContext } from "../../context/notify.context.jsx";

const ProductGroupActiveToggle = ({ record, loadGroups }) => {
    ...
    const handleToggleActive = async () => {
        try {
            setLoading(true);
            await updateProductGroupAPI(record.id, {
...
export default ProductGroupActiveToggle;
