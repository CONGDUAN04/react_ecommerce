...
export const fetchAllUserAPI = () => axios.get("/api/admin/users");
...
export const fetchAllRolesAPI = () => axios.get("/api/admin/roles");
...
export const getHomeProductsAPI = () => axios.get("/");
